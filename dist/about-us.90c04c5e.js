...
(0, _jqueryDefault.default)(document).ready(function() {
    ...
    const showcaseSlide = new (0, _flickityDefault.default)(".showcase__slide", {
        contain: true,
        initialIndex: 1,
    ...
    function initIntro() {
        ...
        const splitH2 = new (0, _splitTypeDefault.default)(DOM.h2, {
            type: "lines, chars",
            linesClass: "line",
            charsClass: "char",
            position: "relative"
        });
        const splitStatisticNumber = new (0, _splitTypeDefault.default)(DOM.statisticNumber, {
            type: "lines, chars",
            linesClass: "line",
            charsClass: "char",
            position: "relative"
        ...
        tl1.from(DOM.headline, {
            ...
            y: "+=5vh",
            duration: 2
        }, "<= .3").from(DOM.h2.querySelector(".line__inner"), {
            ease: "power4",
            y: 200,
            duration: 1.5
        }, "<= 0").from(DOM.desc, {
        ...
        tl2.from(DOM.statisticNumber, {
            ...
            duration: 2,
            stagger: 0.2
        }).from(".intro .statistic-number .line__inner", {
            ease: "power4",
            y: 200,
            duration: 1.5,
            stagger: 0.2
        }, 0).from(DOM.statisticDesc, {
            ease: "power4",
            opacity: 0,
            y: "+=5vh",
            duration: 2,
    ...
    function initSolution() {
        ...
        tl1.from(DOM.headline, {
            ...
            y: "+=5vh",
            duration: 1.8
        }, 0).from(DOM.headline.querySelector(".line__inner"), {
            ease: "power4",
            y: 200,
            duration: 1.3
        }, "<= 0").from(DOM.h2, {
    ...
    function initShowcase() {
        ...
        tl1.from(DOM.h2, {
            ...
            y: "+=5vh",
            duration: 2
        }, 0).from(DOM.h2.querySelector(".line__inner"), {
            ease: "power4",
            y: 200,
            duration: 1.5
        }, "<= 0").from(DOM.desc, {
    ...
    function initTeam() {
        ...
        tl1.from(DOM.headline, {
            ...
            y: "+=5vh",
            duration: 2.5
        }, "<= 0.5").from(DOM.h2.querySelector(".line__inner"), {
            ease: "power4",
            y: 200,
            duration: 2
        }, "<= 0").from(DOM.desc, {
    ...
    function initEfficiency() {
        ...
        tl2.from(DOM.chartColumn, {
            ease: "power4",
            opacity: 0,
            x: -50,
            duration: 1.8,
            stagger: 0.2
        }, 0).from(DOM.chartLine, {
            ease: "power4",
            filter: "blur(1px)",
    ...
    function initParallax() {
        ...
        (0, _gsap.gsap).fromTo(DOM.bannerImg, {
            y: "-20vh"
        }, {
            y: "20vh",
            scrollTrigger: {
...
},{"jquery":"hgMhh","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","split-type":"fvGAG","flickity":"38Yk4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38Yk4":[function(require,module,exports) {
/*!
 * Flickity v3.0.0
...
/* eslint-disable max-params */ (function(window1, factory) {
    ...
    module.exports = factory(window1, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate"));
    else {
        // browser global
...
(function(window1, factory) {
    // universal module definition
    if (module.exports) // CommonJS
    module.exports = factory(window1, require("./core"), require("unidragger"), require("fizzy-ui-utils"));
    else // browser global
...
},{"ev-emitter":"7rCHo"}]},["3ajya","hS7Ir"], "hS7Ir", "parcelRequiref404")

//# sourceMappingURL=about-us.90c04c5e.js.map
